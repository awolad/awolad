    ...
    <>
      <section id="home" className="home d-flex align-items-center">
        <div className="container">
          <div className="intro">
            <img src="/assets/images/awolad/awolad-white.jpg" alt="Awolad" className="mb-4" />
            <h1 className="mb-2 mt-0">Awolad Hossain</h1>
            <span>I'm&nbsp;
              <span className="text-rotating">
                a Front-end developer,
                a Back-end developer,
                an Alexa skill developer,
                a Google action developer
              </span>
            </span>
            <ul className="social-icons light list-inline mb-0 mt-4">
              <li className="list-inline-item"><a href="https://www.linkedin.com/in/awolad" target="_blank" rel="noreferrer">
                <i className="fab fa-linkedin"></i></a>
              </li>
              <li className="list-inline-item"><a href="https://github.com/awolad" target="_blank" rel="noreferrer">
                <i className="fab fa-github"></i></a>
              </li>
              <li className="list-inline-item"><a href="https://twitter.com/awolad_hossain" target="_blank" rel="noreferrer">
                <i className="fab fa-twitter"></i></a>
              </li>
              <li className="list-inline-item"><a href="https://www.facebook.com/awolad1122" target="_blank" rel="noreferrer">
                <i className="fab fa-facebook"></i></a>
              </li>
              <li className="list-inline-item"><a href="https://www.instagram.com/awolad_hossain" target="_blank" rel="noreferrer">
